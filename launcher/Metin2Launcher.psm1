...
function Get-M2DefaultLauncherConfig {
    ...
    # Metin2 Playerbots Mod: official updates are off -- they would unpack
    # upstream over the mod. Put the mod's own manifest URL here to enable them.
    $manifest = ''
...
function Get-M2UpdateManifest {
    ...
    if ([string]::IsNullOrWhiteSpace($Source)) {
        throw 'Aktualizacje są wyłączone w tej paczce modyfikacji (oficjalna aktualizacja nadpisałaby zmiany moda).'
    }
