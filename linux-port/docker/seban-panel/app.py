...
PLAYERBOTS_RELEASE_URL = os.environ.get("PLAYERBOTS_RELEASE_URL", "https://api.github.com/repos/zaxerrrr-dot/mt2009-sp-plus/releases/latest")  # Metin2 Playerbots Mod: the mod's releases
